...
def work_reference(pawns, minimum_construction=0):
    assignments, capacity = work_assignment(pawns, minimum_skills={'Construction': minimum_construction})
    ...
    return {'assignments': assignments, 'capacity': capacity, 'matches': matches,
            'minimum_construction': minimum_construction}
