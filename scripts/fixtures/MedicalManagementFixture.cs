            ...
            return await ctx.MainThread.InvokeAsync<object>(() => {
                ...
                foreach (var pawn in people) {
                    ...
                    foreach (var work in new[] { "Doctor", "Patient", "PatientBedRest" }) {
                        ...
                        if (!pawn.WorkTypeIsDisabled(def)) pawn.workSettings.SetPriority(def, 1);
                    }
                }
                ...
                foreach (var pawn in people.Take(2)) {
                    stage = "disease";
                ...
                return new { success = true, setupOnly = true, completedWorkInjected = false,
