...
async def run(args):
    ...
    try:
        ...
        await ready(rt)
        rt.execution_task=asyncio.current_task()  # This isolated probe drives the shared Hands explicitly.
        ...
        assert p.state=='blocked' and p.failure.code=='construction_resources' and not p.issued,p.model_dump()
