...
@asynccontextmanager
async def service(binary, gabs, configuration, profile, state, directory, report, *, clock_control=False, routine_reviews=False, routine_methods=False, routine_cooking=False, routine_shelter=False, routine_comfort=False, routine_expansion=False, routine_power=False, routine_temperature=False, resource_rules=()):
    directory.mkdir()
    ...
    if routine_methods:
        ...
        planner = "--routine-temperature-plans" if routine_temperature else "--routine-power-plans" if routine_power else "--routine-expansion-plans" if routine_expansion else "--routine-comfort-plans" if routine_comfort else "--routine-shelter-plans" if routine_shelter else "--routine-sleeping-plans"
    ...
    assert not routine_temperature or routine_methods
    if routine_cooking:
        assert routine_reviews
