...
@asynccontextmanager
async def service(binary, gabs, configuration, profile, state, directory, report, *, clock_control=False, routine_reviews=False, routine_methods=False, routine_cooking=False, routine_shelter=False, routine_comfort=False, resource_rules=()):
    directory.mkdir()
    ...
    if routine_methods:
        ...
        planner = "--routine-comfort-plans" if routine_comfort else "--routine-shelter-plans" if routine_shelter else "--routine-sleeping-plans"
