...
param(
    ...
    [ValidateSet('HomeCoverageFixture', 'InterruptionFixture', 'SleepingFixture', 'StoreroomFixture', 'MedicineFixture', 'AnimalContainmentFixture', 'AnimalFeedFixture', 'ComfortFixture', 'ResearchObservationFixture', 'RoutineSleepingFixture', 'RoutineProductionFixture', 'GuardedConstructionFixture', 'StorageHaulFixture', 'ThroughputFixture', 'WasteFixture', 'DisasterFixture', 'GearFixture',
        ...
        'MiningFixture', 'FoodObservationFixture', 'FoodChannelFixture', 'FishingFixture', 'HuntSelectionFixture', 'UpkeepFixture', 'TradeFixture',
        'ScenarioStartFixture', 'ConstructionLedgerFixture', 'EmergencyDevelopmentFixture',
        'InstallFixture', 'ForecastFixture', 'InspectorFixture', 'ModalFixture', 'CampaignMetricsFixture', 'DraftFaultFixture', 'RuntimeFaultFixture', 'MapScopeFixture', 'QuestFulfillFixture', 'BuildingTemperatureFixture', 'SurgeryFixture', 'CaravanControlFixture', 'CaravanDepartureFixture', 'RecoveryServiceFixture', 'QuestAcceptFixture', 'SettlementGiftFixture', 'RecoveryAreaFixture', 'BedAssignFixture', 'ZoneDeleteFixture', 'ApplyRefusalFixture', 'RefrigerationFixture', 'PowerFixture', 'CleanlinessFixture', 'DefenseFixture', 'LightingFixture', 'FlooringFixture', 'RoutesFixture', 'MountainFixture', 'CorridorTerrainFixture', 'HutShellFixture', 'QuietStorytellerFixture', 'DebugStartFixture', 'LetterFixture', 'FreezeNeedsFixture', 'VideoSourceFixture', 'VideoMatrixFixture', 'WallUpgradeFixture', 'ShutdownFixture', 'FarmEnvironmentFixture', 'DialogFixture', 'NamingFixture', 'ProductionLadderFixture', 'ResearchLadderFixture', 'BlightFixture', 'WinterFixture', 'PestFixture', 'CellsFixture', 'ConditionFixture', 'EntitiesFixture')]
    [string[]]$Fixture = @()
)
