...
from rimgovernor.headless import prepare, prepare_rendered, isolated_root
import pytest


def test_headless_profile_leaves_interactive_configuration_unchanged(tmp_path):
    root=tmp_path/'bridge';game=tmp_path/'game'
    dll=game/'Mods/RimGovernorHeadless/Assemblies/HeadlessRimPatch.dll'
...
def test_rendered_baseline_only_ignores_headless_metadata(tmp_path,missing,allowed):
    ...
    save=tmp_path/'profile/Saves/RimGovernor-tribal8-baseline.rws'
