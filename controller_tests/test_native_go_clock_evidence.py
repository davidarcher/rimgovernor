...
def test_routine_evidence_requires_native_scope_unknown_forecast_and_manual_retirement(tmp_path, fault):
    ...
    needs = ["ConfirmColonyNames", "ActiveCombat", "CriticalMedical", "RestoreWorkers", "AllowStartingSupplies",
             ...
             "EnsureCooking", "EnsureBasicPower", "EnsureFoodStorage", "EnsureBasicDefense", "MaintainWood", "MaintainMedicalCare"]
    ...
    if fault:
        ...
        assert len(probe.routine_evidence(path, identity, enabled=False, expected_food_need="unknown")["goals"]) == 15
