...
Choose a guide for the outcome you need. Commands run from the repository root. For a
first guided exercise, use [your first Docker test](../tutorials/first-docker-test.md).
...
- [Migrate an owned legacy session](legacy-migration.md)
...
- [Verify medical care and surgery](medical-care-acceptance.md)
