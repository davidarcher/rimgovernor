...
and observes the native postconditions. The fixture supplies a covered stockpile,
medicine, a damaged wall, aged dirt and enabled workers. Setup does not establish
construction acceptance; subsequent work uses normal game jobs without inference.
...
certify new storage construction, bed upgrades, safe wall replacement, sustained
