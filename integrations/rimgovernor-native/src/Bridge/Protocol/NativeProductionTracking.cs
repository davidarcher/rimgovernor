...
namespace HomeBridge.BridgeTools {
 ...
 internal static class NativeProductionTracking {
  ...
  internal static Bill? ReplaceableBill(string id,Map map)=>map.listerThings.AllThings.OfType<IBillGiver>().SelectMany(g=>g.BillStack.Bills).FirstOrDefault(b=>b.GetUniqueLoadID()==id&&OrdinaryMeal(b.recipe));
