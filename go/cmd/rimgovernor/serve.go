...
func parseServe(args []string, diagnostics io.Writer) (serveConfig, error) {
	...
	// Defense/tend/rescue/equip/secure-supplies/repair/clean/haul/gear/medical/animal-containment/recovery/husbandry/prisoner-interaction/population-custody/home-coverage/stone-shell/research/resource/production-policy
