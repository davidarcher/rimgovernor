// The construction/build case proves two NativeConstructionPlan/NativeConstructionRecord
...
func init() {
	cases.Register(cases.Case{
		...
		Scope: "Real typed PlaceBuilding admission for an Instant (WorkToBuild==0) building " +
