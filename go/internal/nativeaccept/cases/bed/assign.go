// The bed/assign case exercises the typed AssignBed native dispatch
...
// so unlike recoveryserviceaccept this case does not poll game ticks to
// completion.
//
...
func init() {
	cases.Register(cases.Case{
		Name: "bed/assign",
		Scope: "Native CompAssignableToPawn.TryAssignPawn (typed AssignBed) dispatch: a colonist who " +
...
func run(ctx context.Context, s cases.Session) error {
	...
	// takeover path. Only one dispatch happens in this case (no Fast-speed
	...
	// advances over wall-clock/tick time independent of this case's own
	// writes.
