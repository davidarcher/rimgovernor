// The custody/population case exercises the population custody native
...
func init() {
	cases.Register(cases.Case{
		...
		Scope: "Native population custody dispatch: an actual Capture job carries a downed hostile " +
