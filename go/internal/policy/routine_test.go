...
func stableRoutine() RoutineFacts {
	...
	return RoutineFacts{
		...
		Hostiles: domain.Known(int64(0)), CriticalPatients: domain.Known(int64(0)), ColonyNaming: domain.Known(false), ChoiceDialog: domain.Known(false), CleanupPawns: domain.Known(false), ForbiddenSupplies: domain.Known(false),
