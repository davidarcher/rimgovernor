...
func caravanDepartureRequest(t *testing.T) CaravanDepartureRequest {
	...
	facts := CaravanDepartureFacts{
		...
		Cargo: CaravanCargoPlan{
			Cargo:          []CaravanCargoSelection{{GroupID: "g-meals", Definition: "MealSimple", Count: 10}, {GroupID: "g-pemmican", Definition: "Pemmican", Count: 30}},
			Food:           []CaravanFoodCargo{{GroupID: "g-pemmican", Count: 30}},
			HomeRunwayDays: 20,
		},
	...
	policy := CaravanDeparturePolicy{MinimumHomeColonists: 1, MinimumHomeFoodDays: 5, TravelFoodMarginDays: 2, KeepHomeDoctor: true, MinimumDestinationTemperatureC: -10, MaximumDestinationTemperatureC: 40, MinimumGoodwill: -50}
...
func TestCaravanDepartureDefenseHolds(t *testing.T) {
	cases := []struct {
		...
		{"no food packed", func(r *CaravanDepartureRequest) { r.Facts.Cargo.Food = nil }, UnknownFacts},
		{"cargo unresolved", func(r *CaravanDepartureRequest) { r.Facts.Cargo.Cargo = r.Facts.Cargo.Cargo[1:] }, UnknownFacts},
		{"insufficient home food", func(r *CaravanDepartureRequest) { r.Facts.CargoRefusal = CaravanHomeFoodInsufficient }, CaravanHomeFoodInsufficient},
		{"insufficient journey food", func(r *CaravanDepartureRequest) { r.Facts.CargoRefusal = CaravanFoodInsufficient }, CaravanFoodInsufficient},
