...
func newBillBoundaryFixture(t *testing.T) (*billBoundary, *billBoundaryFixture, executor.Target, executor.Placement, domain.ProductionBill) {
	...
	ctx := &c.ObservationContext{Identity: boundaryIdentity(snapshot), Tick: proto.Int64(11), NativeGeneration: proto.Uint64(1)}
...
func TestObserveBillCompletedUnsuccessfulAndAbsent(t *testing.T) {
	...
	progressCtx := &c.ObservationContext{Identity: boundaryIdentity(placement.Snapshot), Tick: proto.Int64(11), NativeGeneration: proto.Uint64(1)}
...
func boundaryContextFor(s domain.GenerationSnapshot) *c.ObservationContext {
	return &c.ObservationContext{Identity: boundaryIdentity(s), Tick: proto.Int64(int64(10)), NativeGeneration: proto.Uint64(uint64(s.Native))}
}
