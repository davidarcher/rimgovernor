...
type PlanState struct {
	...
	CoverClearanceAdmissions      []ActionCoverClearanceAdmission
...
CREATE TABLE actions(id TEXT PRIMARY KEY, plan_id TEXT NOT NULL REFERENCES plans(id), ordinal INTEGER NOT NULL, kind TEXT NOT NULL CHECK(kind IN ('building','owned_draft','melee_attack','supply_allow','supply_forbid','work_assignment','acquisition','zone_create','tend','rescue','capture','ranged_attack','production_bill','haul','equip','gear_replace','apparel_policy','repair','clean','waste','recovery_service','movement','research_select','husbandry','home_coverage','prisoner_interaction','quest_accept','mine_acquisition','wall_removal','excavation','production_policy','building_temperature','bed_medical','grower_crop','bed_assign','mood_relief','dialog_answer','naming_confirmation','cut_plant','cover_clearance','deconstruction','trade','claim_building','zone_delete','open_casket','caravan_departure')), definition TEXT, x INTEGER, z INTEGER, rotation TEXT, stuff TEXT, pawn TEXT, target TEXT, draft_action TEXT REFERENCES actions(id), work_payload BLOB, zone_payload BLOB, bill_payload BLOB, wall_removal_payload BLOB, production_policy_payload BLOB, building_temperature_payload BLOB, mood_relief_payload BLOB, trade_payload BLOB, caravan_payload BLOB, CHECK((kind='trade' AND trade_payload IS NOT NULL) OR (kind<>'trade' AND trade_payload IS NULL)), CHECK((kind='caravan_departure' AND caravan_payload IS NOT NULL) OR (kind<>'caravan_departure' AND caravan_payload IS NULL)), CHECK((kind='building_temperature' AND building_temperature_payload IS NOT NULL) OR (kind<>'building_temperature' AND building_temperature_payload IS NULL)), CHECK((kind='mood_relief' AND mood_relief_payload IS NOT NULL) OR (kind<>'mood_relief' AND mood_relief_payload IS NULL)), CHECK((kind='production_bill' AND bill_payload IS NOT NULL) OR (kind<>'production_bill' AND bill_payload IS NULL)), CHECK((kind='zone_create' AND zone_payload IS NOT NULL) OR (kind!='zone_create' AND zone_payload IS NULL)), CHECK((kind='work_assignment' AND work_payload IS NOT NULL) OR (kind!='work_assignment' AND work_payload IS NULL)), CHECK((kind='wall_removal' AND wall_removal_payload IS NOT NULL) OR (kind<>'wall_removal' AND wall_removal_payload IS NULL)), CHECK((kind='production_policy' AND production_policy_payload IS NOT NULL) OR (kind<>'production_policy' AND production_policy_payload IS NULL)), CHECK((kind IN ('trade','caravan_departure') AND definition IS NULL AND x IS NULL AND z IS NULL AND rotation IS NULL AND stuff IS NULL AND pawn IS NULL AND target IS NULL AND draft_action IS NULL) OR (kind='production_bill' AND definition IS NULL AND x IS NULL AND z IS NULL AND rotation IS NULL AND stuff IS NULL AND pawn IS NULL AND target IS NULL AND draft_action IS NULL) OR (kind='zone_create' AND definition IS NULL AND x IS NULL AND z IS NULL AND rotation IS NULL AND stuff IS NULL AND pawn IS NULL AND target IS NULL AND draft_action IS NULL) OR (kind='wall_removal' AND definition IS NULL AND x IS NULL AND z IS NULL AND rotation IS NULL AND stuff IS NULL AND pawn IS NULL AND target IS NULL AND draft_action IS NULL) OR (kind='production_policy' AND definition IS NULL AND x IS NULL AND z IS NULL AND rotation IS NULL AND stuff IS NULL AND pawn IS NULL AND target IS NULL AND draft_action IS NULL) OR (kind='excavation' AND definition IS NOT NULL AND x IS NOT NULL AND z IS NOT NULL AND rotation IS NULL AND stuff IS NULL AND pawn IS NULL AND target IS NULL AND draft_action IS NULL) OR (kind='building' AND definition IS NOT NULL AND x IS NOT NULL AND z IS NOT NULL AND rotation IS NOT NULL AND stuff IS NOT NULL AND pawn IS NULL AND target IS NULL AND draft_action IS NULL) OR (kind='owned_draft' AND definition IS NULL AND x IS NULL AND z IS NULL AND rotation IS NULL AND stuff IS NULL AND pawn IS NOT NULL AND target IS NULL AND draft_action IS NULL) OR (kind IN ('melee_attack','ranged_attack') AND (definition IS NULL OR (kind='melee_attack' AND definition='subdue')) AND x IS NULL AND z IS NULL AND rotation IS NULL AND stuff IS NULL AND pawn IS NOT NULL AND target IS NOT NULL AND draft_action IS NOT NULL) OR (kind IN ('supply_allow','supply_forbid','acquisition','mine_acquisition','cut_plant') AND definition IS NOT NULL AND x IS NOT NULL AND z IS NOT NULL AND rotation IS NULL AND stuff IS NULL AND pawn IS NULL AND target IS NOT NULL AND draft_action IS NULL) OR (kind='deconstruction' AND definition IS NOT NULL AND x IS NOT NULL AND z IS NOT NULL AND rotation IS NULL AND (stuff IS NULL OR stuff IN ('breach','drill')) AND pawn IS NULL AND target IS NOT NULL AND draft_action IS NULL) OR (kind='cover_clearance' AND definition IS NOT NULL AND x IS NOT NULL AND z IS NOT NULL AND rotation IS NULL AND stuff IN ('Mine','CutPlant','Haul','Deconstruct') AND pawn IS NULL AND target IS NOT NULL AND draft_action IS NULL) OR (kind='work_assignment' AND definition IS NULL AND x IS NULL AND z IS NULL AND rotation IS NULL AND stuff IS NULL AND pawn IS NOT NULL AND target IS NOT NULL AND draft_action IS NULL) OR (kind IN ('tend','rescue','capture') AND (definition IS NULL OR kind='capture') AND x IS NULL AND z IS NULL AND rotation IS NULL AND stuff IS NULL AND pawn IS NOT NULL AND target IS NOT NULL AND draft_action IS NULL) OR (kind='haul' AND definition IS NOT NULL AND x IS NOT NULL AND z IS NOT NULL AND rotation IS NULL AND stuff IS NULL AND pawn IS NOT NULL AND target IS NOT NULL AND draft_action IS NULL) OR (kind='equip' AND definition IS NOT NULL AND x IS NOT NULL AND z IS NOT NULL AND rotation IS NULL AND stuff IS NULL AND pawn IS NOT NULL AND target IS NOT NULL AND draft_action IS NULL) OR (kind='gear_replace' AND definition IS NOT NULL AND x IS NULL AND z IS NULL AND rotation IS NULL AND stuff IS NULL AND pawn IS NOT NULL AND target IS NOT NULL AND draft_action IS NULL) OR (kind IN ('repair','clean','waste','open_casket') AND (definition IS NULL OR (kind='open_casket' AND definition='heat')) AND x IS NOT NULL AND z IS NOT NULL AND rotation IS NULL AND stuff IS NULL AND pawn IS NOT NULL AND target IS NOT NULL AND draft_action IS NULL) OR (kind IN ('recovery_service') AND definition IS NOT NULL AND x IS NULL AND z IS NULL AND rotation IS NULL AND stuff IS NULL AND pawn IS NOT NULL AND target IS NOT NULL AND draft_action IS NULL) OR (kind='movement' AND definition IS NULL AND x IS NOT NULL AND z IS NOT NULL AND rotation IS NULL AND stuff IS NULL AND pawn IS NOT NULL AND target IS NULL AND draft_action IS NOT NULL) OR (kind='research_select' AND definition IS NOT NULL AND x IS NULL AND z IS NULL AND rotation IS NULL AND stuff IS NULL AND pawn IS NULL AND target IS NULL AND draft_action IS NULL) OR (kind='husbandry' AND definition IN ('train','slaughter','tame','release','cancel_slaughter','cancel_release','allowed_area','master','follow_drafted','follow_fieldwork') AND target IS NOT NULL AND pawn IS NULL AND x IS NULL AND z IS NULL AND rotation IS NULL AND draft_action IS NULL AND ((definition='train' AND stuff IS NOT NULL) OR (definition IN ('slaughter','tame','release','cancel_slaughter','cancel_release') AND stuff IS NULL) OR (definition IN ('allowed_area','master')) OR (definition IN ('follow_drafted','follow_fieldwork') AND stuff IN ('true','false')))) OR (kind='home_coverage' AND definition IS NOT NULL AND target IS NOT NULL AND pawn IS NULL AND x IS NULL AND z IS NULL AND rotation IS NULL AND stuff IS NULL AND draft_action IS NULL) OR (kind='prisoner_interaction' AND definition IN ('recruit','maintain') AND target IS NOT NULL AND pawn IS NULL AND x IS NULL AND z IS NULL AND rotation IS NULL AND stuff IS NULL AND draft_action IS NULL) OR (kind='quest_accept' AND target IS NOT NULL AND definition IS NOT NULL AND x IS NULL AND z IS NULL AND rotation IS NULL AND stuff IS NULL AND draft_action IS NULL) OR (kind='building_temperature' AND target IS NOT NULL AND definition IS NULL AND pawn IS NULL AND x IS NULL AND z IS NULL AND rotation IS NULL AND stuff IS NULL AND draft_action IS NULL) OR (kind='bed_medical' AND target IS NOT NULL AND definition IN ('true','false') AND stuff IS NOT NULL AND pawn IS NULL AND x IS NULL AND z IS NULL AND rotation IS NULL AND draft_action IS NULL) OR (kind='grower_crop' AND target IS NOT NULL AND definition IS NOT NULL AND stuff IS NOT NULL AND pawn IS NULL AND x IS NULL AND z IS NULL AND rotation IS NULL AND draft_action IS NULL) OR (kind='bed_assign' AND pawn IS NOT NULL AND target IS NOT NULL AND definition IS NOT NULL AND x IS NULL AND z IS NULL AND rotation IS NULL AND stuff IS NULL AND draft_action IS NULL) OR (kind='mood_relief' AND pawn IS NOT NULL AND definition IS NULL AND target IS NULL AND x IS NULL AND z IS NULL AND rotation IS NULL AND stuff IS NULL AND draft_action IS NULL) OR (kind='apparel_policy' AND definition IS NOT NULL AND x IS NULL AND z IS NULL AND pawn IS NULL AND target IS NULL AND rotation IS NULL AND stuff IS NULL AND draft_action IS NULL) OR (kind='dialog_answer' AND definition IS NOT NULL AND x IS NOT NULL AND z IS NOT NULL AND pawn IS NULL AND target IS NULL AND rotation IS NULL AND draft_action IS NULL) OR (kind='naming_confirmation' AND definition IS NOT NULL AND stuff IS NOT NULL AND x IS NOT NULL AND z IS NULL AND pawn IS NULL AND target IS NULL AND rotation IS NULL AND draft_action IS NULL) OR (kind IN ('claim_building','zone_delete') AND target IS NOT NULL AND stuff IS NOT NULL AND definition IS NULL AND pawn IS NULL AND x IS NULL AND z IS NULL AND rotation IS NULL AND draft_action IS NULL)), UNIQUE(plan_id,ordinal)) STRICT;
...
CREATE TABLE cover_clearance_admissions(action_id TEXT PRIMARY KEY REFERENCES actions(id), payload BLOB NOT NULL) STRICT;
...
func load(ctx context.Context, tx *sql.Tx, id domain.PlanID) (PlanState, error) {
	...
	for _, a := range actions {
		...
		deconstructionAdmission, deconstructionPresent, e := loadDeconstructionAdmission(ctx, tx, a, p)
		if e != nil {
			return PlanState{}, e
		}
		if a.Kind() == domain.DeconstructionAction && !deconstructionPresent && (p.View().Stage == domain.Prepared || p.View().Attempt > 0) {
			return PlanState{}, errors.New("deconstruction progress lacks admission")
		}
		...
		coverClearanceAdmission, coverClearancePresent, e := loadCoverClearanceAdmission(ctx, tx, a, p)
		if e != nil {
			return PlanState{}, e
		}
		if a.Kind() == domain.CoverClearanceAction && !coverClearancePresent && (p.View().Stage == domain.Prepared || p.View().Attempt > 0) {
			return PlanState{}, errors.New("cover clearance progress lacks admission")
		}
		if coverClearancePresent {
			state.CoverClearanceAdmissions = append(state.CoverClearanceAdmissions, ActionCoverClearanceAdmission{Action: a.ID(), Admission: coverClearanceAdmission})
		}
...
func advanceInTransaction(ctx context.Context, tx *sql.Tx, plan domain.PlanID, action domain.ActionID, event transition) (domain.Progress, error) {
	...
	if current.Action().Kind() == domain.DeconstructionAction {
		if event.Kind == "prepare" {
			return domain.Progress{}, errors.New("deconstruction requires typed preparation")
		}
	...
	if current.Action().Kind() == domain.CoverClearanceAction {
		if event.Kind == "prepare" {
			return domain.Progress{}, errors.New("cover clearance requires typed preparation")
		}
		if event.Kind == "dispatch" && !coverClearanceGuardDispatch(state.CoverClearanceAdmissions, action, event.Snapshot, event.Tick) {
			return domain.Progress{}, errors.New("cover clearance dispatch lacks current admission")
		}
	}
