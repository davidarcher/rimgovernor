...
type Snapshot struct {
	...
	// construction intent a cancel_construction command may withdraw. An
...
// knownConstructionIntent bounds cancel_construction's target against the
// already-submitted construction intents, so a model can only withdraw a room
// it can see was actually ordered.
