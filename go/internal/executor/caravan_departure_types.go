...
// CaravanDepartureBoundary mirrors GearReplaceBoundary/EquipBoundary: the
// action names crew, trade cargo and destination; the boundary reads the
// native caravan catalog, composes the pack with the crew's journey food
// (policy.PlanCaravanCargo, #464) and previews it. FormCaravan is a one-shot
// native operation, the same shape Draft/Attack/Equip use; the executor
// observes departure via the native world census
// (world_progression.caravan_outcome), not a second dispatch.
