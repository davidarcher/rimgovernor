...
func (n *caravanDepartureEnvironment) caravanDepartureFacts(target Target) policy.CaravanDepartureFacts {
	...
	return policy.CaravanDepartureFacts{Snapshot: target.Snapshot, PawnTick: n.tick, PreviewTick: n.tick, Crew: crew, CatalogToken: "catalog-token", RemainingHomeColonists: domain.Known(uint32(5)), HomeDoctorAvailable: domain.Known(true), Cargo: policy.CaravanCargoPlan{Cargo: []policy.CaravanCargoSelection{{GroupID: "g-meals", Definition: "MealSimple", Count: 10}, {GroupID: "g-pemmican", Definition: "Pemmican", Count: 20}}, Food: []policy.CaravanFoodCargo{{GroupID: "g-pemmican", Count: 20}}, HomeRunwayDays: 30}, RouteReachable: domain.Known(true), RouteTemperatureC: domain.Known(15.0), RouteHostile: domain.Known(false), RouteFactionID: "faction-1", RouteGoodwill: domain.Known(int32(0)), RouteFoodRotDays: domain.Known(9.0), NativeCanTry: domain.Known(!n.ineligible)}
}
