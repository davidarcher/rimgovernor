...
var reasonHeldReasons = map[policy.Reason]domain.HeldReason{
	...
	policy.BedAssignPawnUnavailable:        domain.HeldBedAssignPawnUnavailable,
	policy.CaravanCrewUnavailable:          domain.HeldCaravanCrewUnavailable,
	policy.CaravanHomeFoodInsufficient:     domain.HeldCaravanHomeFoodInsufficient,
	policy.CaravanHomeStaffingInsufficient: domain.HeldCaravanHomeStaffingInsufficient,
	policy.CaravanRouteUnavailable:         domain.HeldCaravanRouteUnavailable,
	...
	policy.InsufficientReserve:             domain.HeldInsufficientReserve,
	...
	policy.QuestUnavailable:                domain.HeldQuestUnavailable,
	...
	policy.SettlementUnavailable:           domain.HeldSettlementUnavailable,
