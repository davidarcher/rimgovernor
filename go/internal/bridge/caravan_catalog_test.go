...
func caravanCatalogFixture() *o.CaravanCatalog {
	return &o.CaravanCatalog{
		...
		CargoGroups:  []*o.CargoGroup{{GroupId: proto.String("group-1"), DefName: proto.String("Steel"), Count: proto.Int64(50)}},
...
func TestReadCaravanCatalogAcceptsValidObservation(t *testing.T) {
	...
	if err != nil || len(raw.Envelope) == 0 || out.Token != "catalog-token" || len(out.CargoGroups) != 1 || len(out.Routes) != 1 {
		t.Fatal(out, err)
	}
}
