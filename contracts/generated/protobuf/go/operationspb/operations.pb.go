...
const (
	...
	ZoneType_ZONE_TYPE_FISHING     ZoneType = 4
)
...
const (
	...
	PawnOrderKind_PAWN_ORDER_KIND_SUBDUE           PawnOrderKind = 10
	PawnOrderKind_PAWN_ORDER_KIND_OPEN_CASKET_HEAT PawnOrderKind = 11
)
...
var (
	PawnOrderKind_name = map[int32]string{
		...
		10: "PAWN_ORDER_KIND_SUBDUE",
		11: "PAWN_ORDER_KIND_OPEN_CASKET_HEAT",
	}
	PawnOrderKind_value = map[string]int32{
		...
		"PAWN_ORDER_KIND_SUBDUE":           10,
		"PAWN_ORDER_KIND_OPEN_CASKET_HEAT": 11,
	}
)
...
func (x *Operation) GetArrest() *Arrest {
	if x != nil {
		if x, ok := x.Command.(*Operation_Arrest); ok {
			return x.Arrest
		}
	}
	return nil
...
func (x *BillSettings) GetBeerReserve() bool {
	if x != nil && x.BeerReserve != nil {
...
type FishingSettings struct {
	state           protoimpl.MessageState `protogen:"open.v1"`
	PopulationFloor *float64               `protobuf:"fixed64,1,opt,name=population_floor,json=populationFloor,proto3,oneof" json:"population_floor,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *FishingSettings) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *FishingSettings) GetPopulationFloor() float64 {
	if x != nil && x.PopulationFloor != nil {
		return *x.PopulationFloor
	}
	return 0
}
...
type Arrest struct {
	...
	Bed           *EntityPrecondition    `protobuf:"bytes,3,opt,name=bed,proto3" json:"bed,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Arrest) GetTarget() *EntityPrecondition {
	if x != nil {
		return x.Target
	}
	return nil
...
func (x *Arrest) GetBed() *EntityPrecondition {
	if x != nil {
		return x.Bed
	}
	return nil
...
const file_operations_proto_rawDesc = "" +
	...
	"\x0fset_drug_policy\x18; \x01(\v2(.rimgovernor.operations.v1.SetDrugPolicyH\x00R\rsetDrugPolicyB\t\n" +
	"\acommand\"\x9d\x01\n" +
	...
	"\x18STORE_MODE_DROP_ON_FLOOR\x10\x02*\x83\x01\n" +
	"\bZoneType\x12\x19\n" +
	"\x15ZONE_TYPE_UNSPECIFIED\x10\x00\x12\x17\n" +
	"\x13ZONE_TYPE_STOCKPILE\x10\x01\x12\x15\n" +
	"\x11ZONE_TYPE_DUMPING\x10\x02\x12\x15\n" +
	"\x11ZONE_TYPE_GROWING\x10\x03\x12\x15\n" +
	"\x11ZONE_TYPE_FISHING\x10\x04*\xc9\x01\n" +
	...
	"\x12ATTACK_MODE_RANGED\x10\x03*\xec\x02\n" +
	...
	"\x12$\n" +
	" PAWN_ORDER_KIND_OPEN_CASKET_HEAT\x10\v*j\n" +
...
var file_operations_proto_goTypes = []any{
	...
	(*PlaceBuilding)(nil),                  // 36: rimgovernor.operations.v1.PlaceBuilding
	...
	(*PatchBuilding)(nil),                  // 43: rimgovernor.operations.v1.PatchBuilding
	(*WorkPriority)(nil),                   // 44: rimgovernor.operations.v1.WorkPriority
	(*Schedule)(nil),                       // 45: rimgovernor.operations.v1.Schedule
	(*Training)(nil),                       // 46: rimgovernor.operations.v1.Training
	(*PatchPawn)(nil),                      // 47: rimgovernor.operations.v1.PatchPawn
	...
	(*AddBill)(nil),                        // 53: rimgovernor.operations.v1.AddBill
	(*BillPrecondition)(nil),               // 54: rimgovernor.operations.v1.BillPrecondition
	(*PatchBill)(nil),                      // 55: rimgovernor.operations.v1.PatchBill
	(*DeleteBill)(nil),                     // 56: rimgovernor.operations.v1.DeleteBill
	(*MoveBill)(nil),                       // 57: rimgovernor.operations.v1.MoveBill
	(*SelectResearch)(nil),                 // 58: rimgovernor.operations.v1.SelectResearch
	(*DrillPolicy)(nil),                    // 59: rimgovernor.operations.v1.DrillPolicy
	(*DefCounts)(nil),                      // 60: rimgovernor.operations.v1.DefCounts
	(*DefinitionList)(nil),                 // 61: rimgovernor.operations.v1.DefinitionList
	(*DrillPolicies)(nil),                  // 62: rimgovernor.operations.v1.DrillPolicies
	(*SetProductionPolicy)(nil),            // 63: rimgovernor.operations.v1.SetProductionPolicy
	(*StockpileSettings)(nil),              // 64: rimgovernor.operations.v1.StockpileSettings
	(*GrowingSettings)(nil),                // 65: rimgovernor.operations.v1.GrowingSettings
	(*FishingSettings)(nil),                // 66: rimgovernor.operations.v1.FishingSettings
	(*CreateZone)(nil),                     // 67: rimgovernor.operations.v1.CreateZone
	(*DeleteZone)(nil),                     // 68: rimgovernor.operations.v1.DeleteZone
	(*EditZoneCells)(nil),                  // 69: rimgovernor.operations.v1.EditZoneCells
	(*RepairZone)(nil),                     // 70: rimgovernor.operations.v1.RepairZone
	(*PatchStockpile)(nil),                 // 71: rimgovernor.operations.v1.PatchStockpile
	(*PatchGrowing)(nil),                   // 72: rimgovernor.operations.v1.PatchGrowing
	(*ExtendHome)(nil),                     // 73: rimgovernor.operations.v1.ExtendHome
	(*AssignBed)(nil),                      // 74: rimgovernor.operations.v1.AssignBed
	(*Deconstruct)(nil),                    // 75: rimgovernor.operations.v1.Deconstruct
	(*ReleaseDeconstructions)(nil),         // 76: rimgovernor.operations.v1.ReleaseDeconstructions
	(*RemoveWall)(nil),                     // 77: rimgovernor.operations.v1.RemoveWall
	(*Arrest)(nil),                         // 78: rimgovernor.operations.v1.Arrest
	(*ReleaseWallRemovals)(nil),            // 79: rimgovernor.operations.v1.ReleaseWallRemovals
	(*RecoveryArea)(nil),                   // 80: rimgovernor.operations.v1.RecoveryArea
	(*RecoverService)(nil),                 // 81: rimgovernor.operations.v1.RecoverService
	(*ManageWaste)(nil),                    // 82: rimgovernor.operations.v1.ManageWaste
	(*ExpectedJob)(nil),                    // 83: rimgovernor.operations.v1.ExpectedJob
	(*RelieveNeed)(nil),                    // 84: rimgovernor.operations.v1.RelieveNeed
	(*ImproveGear)(nil),                    // 85: rimgovernor.operations.v1.ImproveGear
	(*QueueSurgery)(nil),                   // 86: rimgovernor.operations.v1.QueueSurgery
	(*SetAnimalTraining)(nil),              // 87: rimgovernor.operations.v1.SetAnimalTraining
	(*SlaughterAnimal)(nil),                // 88: rimgovernor.operations.v1.SlaughterAnimal
	(*TameAnimal)(nil),                     // 89: rimgovernor.operations.v1.TameAnimal
	(*ReleaseAnimal)(nil),                  // 90: rimgovernor.operations.v1.ReleaseAnimal
	(*SetAnimalArea)(nil),                  // 91: rimgovernor.operations.v1.SetAnimalArea
	(*SetAnimalMaster)(nil),                // 92: rimgovernor.operations.v1.SetAnimalMaster
	(*SetAnimalFollowing)(nil),             // 93: rimgovernor.operations.v1.SetAnimalFollowing
	(*SetPrisonerInteraction)(nil),         // 94: rimgovernor.operations.v1.SetPrisonerInteraction
	(*SetDrafted)(nil),                     // 95: rimgovernor.operations.v1.SetDrafted
	(*MovePawn)(nil),                       // 96: rimgovernor.operations.v1.MovePawn
	(*AttackTarget)(nil),                   // 97: rimgovernor.operations.v1.AttackTarget
	(*PawnTargetOrder)(nil),                // 98: rimgovernor.operations.v1.PawnTargetOrder
	(*OpenTrade)(nil),                      // 99: rimgovernor.operations.v1.OpenTrade
	(*TradeLine)(nil),                      // 100: rimgovernor.operations.v1.TradeLine
	(*SetTradeLines)(nil),                  // 101: rimgovernor.operations.v1.SetTradeLines
	(*AcceptTrade)(nil),                    // 102: rimgovernor.operations.v1.AcceptTrade
	(*EndTrade)(nil),                       // 103: rimgovernor.operations.v1.EndTrade
	(*CargoSelection)(nil),                 // 104: rimgovernor.operations.v1.CargoSelection
	(*FormCaravan)(nil),                    // 105: rimgovernor.operations.v1.FormCaravan
	(*TravelCaravan)(nil),                  // 106: rimgovernor.operations.v1.TravelCaravan
	(*GiftCaravanSilver)(nil),              // 107: rimgovernor.operations.v1.GiftCaravanSilver
	(*AcceptQuest)(nil),                    // 108: rimgovernor.operations.v1.AcceptQuest
	(*FulfillQuest)(nil),                   // 109: rimgovernor.operations.v1.FulfillQuest
	(*ConfirmColonyNames)(nil),             // 110: rimgovernor.operations.v1.ConfirmColonyNames
	(*AnswerDialog)(nil),                   // 111: rimgovernor.operations.v1.AnswerDialog
	(*ReleaseOwnedDraftRequest)(nil),       // 112: rimgovernor.operations.v1.ReleaseOwnedDraftRequest
	(*DraftRelease)(nil),                   // 113: rimgovernor.operations.v1.DraftRelease
	(*DraftReleaseUncertain)(nil),          // 114: rimgovernor.operations.v1.DraftReleaseUncertain
	(*ReleaseOwnedDraftReply)(nil),         // 115: rimgovernor.operations.v1.ReleaseOwnedDraftReply
	(*SetApparelPolicy)(nil),               // 116: rimgovernor.operations.v1.SetApparelPolicy
...
var file_operations_proto_depIdxs = []int32{
	...
	123, // 13: rimgovernor.operations.v1.PreviewEvaluation.placement:type_name -> rimgovernor.placement.v1.PlacementEvaluated
	...
	32,  // 18: rimgovernor.operations.v1.SurgeryPreparation.missing_ingredients:type_name -> rimgovernor.operations.v1.DefCount
	...
	43,  // 24: rimgovernor.operations.v1.Operation.patch_building:type_name -> rimgovernor.operations.v1.PatchBuilding
	47,  // 25: rimgovernor.operations.v1.Operation.patch_pawn:type_name -> rimgovernor.operations.v1.PatchPawn
	53,  // 26: rimgovernor.operations.v1.Operation.add_bill:type_name -> rimgovernor.operations.v1.AddBill
	55,  // 27: rimgovernor.operations.v1.Operation.patch_bill:type_name -> rimgovernor.operations.v1.PatchBill
	56,  // 28: rimgovernor.operations.v1.Operation.delete_bill:type_name -> rimgovernor.operations.v1.DeleteBill
	57,  // 29: rimgovernor.operations.v1.Operation.move_bill:type_name -> rimgovernor.operations.v1.MoveBill
	58,  // 30: rimgovernor.operations.v1.Operation.select_research:type_name -> rimgovernor.operations.v1.SelectResearch
	63,  // 31: rimgovernor.operations.v1.Operation.set_production_policy:type_name -> rimgovernor.operations.v1.SetProductionPolicy
	67,  // 32: rimgovernor.operations.v1.Operation.create_zone:type_name -> rimgovernor.operations.v1.CreateZone
	68,  // 33: rimgovernor.operations.v1.Operation.delete_zone:type_name -> rimgovernor.operations.v1.DeleteZone
	69,  // 34: rimgovernor.operations.v1.Operation.edit_zone_cells:type_name -> rimgovernor.operations.v1.EditZoneCells
	70,  // 35: rimgovernor.operations.v1.Operation.repair_zone:type_name -> rimgovernor.operations.v1.RepairZone
	71,  // 36: rimgovernor.operations.v1.Operation.patch_stockpile:type_name -> rimgovernor.operations.v1.PatchStockpile
	72,  // 37: rimgovernor.operations.v1.Operation.patch_growing:type_name -> rimgovernor.operations.v1.PatchGrowing
	73,  // 38: rimgovernor.operations.v1.Operation.extend_home:type_name -> rimgovernor.operations.v1.ExtendHome
	74,  // 39: rimgovernor.operations.v1.Operation.assign_bed:type_name -> rimgovernor.operations.v1.AssignBed
	77,  // 40: rimgovernor.operations.v1.Operation.remove_wall:type_name -> rimgovernor.operations.v1.RemoveWall
	79,  // 41: rimgovernor.operations.v1.Operation.release_wall_removals:type_name -> rimgovernor.operations.v1.ReleaseWallRemovals
	80,  // 42: rimgovernor.operations.v1.Operation.recovery_area:type_name -> rimgovernor.operations.v1.RecoveryArea
	81,  // 43: rimgovernor.operations.v1.Operation.recover_service:type_name -> rimgovernor.operations.v1.RecoverService
	82,  // 44: rimgovernor.operations.v1.Operation.manage_waste:type_name -> rimgovernor.operations.v1.ManageWaste
	84,  // 45: rimgovernor.operations.v1.Operation.relieve_need:type_name -> rimgovernor.operations.v1.RelieveNeed
	85,  // 46: rimgovernor.operations.v1.Operation.improve_gear:type_name -> rimgovernor.operations.v1.ImproveGear
	86,  // 47: rimgovernor.operations.v1.Operation.queue_surgery:type_name -> rimgovernor.operations.v1.QueueSurgery
	87,  // 48: rimgovernor.operations.v1.Operation.set_animal_training:type_name -> rimgovernor.operations.v1.SetAnimalTraining
	88,  // 49: rimgovernor.operations.v1.Operation.slaughter_animal:type_name -> rimgovernor.operations.v1.SlaughterAnimal
	94,  // 50: rimgovernor.operations.v1.Operation.set_prisoner_interaction:type_name -> rimgovernor.operations.v1.SetPrisonerInteraction
	95,  // 51: rimgovernor.operations.v1.Operation.set_drafted:type_name -> rimgovernor.operations.v1.SetDrafted
	96,  // 52: rimgovernor.operations.v1.Operation.move_pawn:type_name -> rimgovernor.operations.v1.MovePawn
	97,  // 53: rimgovernor.operations.v1.Operation.attack_target:type_name -> rimgovernor.operations.v1.AttackTarget
	98,  // 54: rimgovernor.operations.v1.Operation.pawn_target_order:type_name -> rimgovernor.operations.v1.PawnTargetOrder
	99,  // 55: rimgovernor.operations.v1.Operation.open_trade:type_name -> rimgovernor.operations.v1.OpenTrade
	101, // 56: rimgovernor.operations.v1.Operation.set_trade_lines:type_name -> rimgovernor.operations.v1.SetTradeLines
	102, // 57: rimgovernor.operations.v1.Operation.accept_trade:type_name -> rimgovernor.operations.v1.AcceptTrade
	103, // 58: rimgovernor.operations.v1.Operation.end_trade:type_name -> rimgovernor.operations.v1.EndTrade
	105, // 59: rimgovernor.operations.v1.Operation.form_caravan:type_name -> rimgovernor.operations.v1.FormCaravan
	106, // 60: rimgovernor.operations.v1.Operation.travel_caravan:type_name -> rimgovernor.operations.v1.TravelCaravan
	107, // 61: rimgovernor.operations.v1.Operation.gift_caravan_silver:type_name -> rimgovernor.operations.v1.GiftCaravanSilver
	108, // 62: rimgovernor.operations.v1.Operation.accept_quest:type_name -> rimgovernor.operations.v1.AcceptQuest
	109, // 63: rimgovernor.operations.v1.Operation.fulfill_quest:type_name -> rimgovernor.operations.v1.FulfillQuest
	110, // 64: rimgovernor.operations.v1.Operation.confirm_colony_names:type_name -> rimgovernor.operations.v1.ConfirmColonyNames
	37,  // 65: rimgovernor.operations.v1.Operation.excavate_cell:type_name -> rimgovernor.operations.v1.ExcavateCell
	89,  // 66: rimgovernor.operations.v1.Operation.tame_animal:type_name -> rimgovernor.operations.v1.TameAnimal
	90,  // 67: rimgovernor.operations.v1.Operation.release_animal:type_name -> rimgovernor.operations.v1.ReleaseAnimal
	91,  // 68: rimgovernor.operations.v1.Operation.set_animal_area:type_name -> rimgovernor.operations.v1.SetAnimalArea
	92,  // 69: rimgovernor.operations.v1.Operation.set_animal_master:type_name -> rimgovernor.operations.v1.SetAnimalMaster
	93,  // 70: rimgovernor.operations.v1.Operation.set_animal_following:type_name -> rimgovernor.operations.v1.SetAnimalFollowing
	111, // 71: rimgovernor.operations.v1.Operation.answer_dialog:type_name -> rimgovernor.operations.v1.AnswerDialog
	41,  // 72: rimgovernor.operations.v1.Operation.cancel_acquisition:type_name -> rimgovernor.operations.v1.CancelAcquisition
	75,  // 73: rimgovernor.operations.v1.Operation.deconstruct:type_name -> rimgovernor.operations.v1.Deconstruct
	76,  // 74: rimgovernor.operations.v1.Operation.release_deconstructions:type_name -> rimgovernor.operations.v1.ReleaseDeconstructions
	78,  // 75: rimgovernor.operations.v1.Operation.arrest:type_name -> rimgovernor.operations.v1.Arrest
	116, // 76: rimgovernor.operations.v1.Operation.set_apparel_policy:type_name -> rimgovernor.operations.v1.SetApparelPolicy
	29,  // 77: rimgovernor.operations.v1.Operation.set_drug_policy:type_name -> rimgovernor.operations.v1.SetDrugPolicy
	28,  // 78: rimgovernor.operations.v1.SetDrugPolicy.pawn:type_name -> rimgovernor.operations.v1.EntityPrecondition
	30,  // 79: rimgovernor.operations.v1.Assignment.clear:type_name -> rimgovernor.operations.v1.Clear
	124, // 80: rimgovernor.operations.v1.CellList.cells:type_name -> rimgovernor.common.v1.Cell
	124, // 81: rimgovernor.operations.v1.Rectangle.origin:type_name -> rimgovernor.common.v1.Cell
	33,  // 82: rimgovernor.operations.v1.Cells.explicit_cells:type_name -> rimgovernor.operations.v1.CellList
	34,  // 83: rimgovernor.operations.v1.Cells.rectangle:type_name -> rimgovernor.operations.v1.Rectangle
	125, // 84: rimgovernor.operations.v1.PlaceBuilding.placement:type_name -> rimgovernor.placement.v1.PlacementCandidate
	124, // 85: rimgovernor.operations.v1.ExcavateCell.cell:type_name -> rimgovernor.common.v1.Cell
	28,  // 86: rimgovernor.operations.v1.CancelConstruction.target:type_name -> rimgovernor.operations.v1.EntityPrecondition
	124, // 87: rimgovernor.operations.v1.CancelConstruction.cell:type_name -> rimgovernor.common.v1.Cell
	28,  // 88: rimgovernor.operations.v1.InstallBuilding.packed_or_inner:type_name -> rimgovernor.operations.v1.EntityPrecondition
	124, // 89: rimgovernor.operations.v1.InstallBuilding.destination:type_name -> rimgovernor.common.v1.Cell
	126, // 90: rimgovernor.operations.v1.InstallBuilding.rotation:type_name -> rimgovernor.placement.v1.Rotation
	28,  // 91: rimgovernor.operations.v1.AcquireResource.source:type_name -> rimgovernor.operations.v1.EntityPrecondition
	124, // 92: rimgovernor.operations.v1.AcquireResource.cell:type_name -> rimgovernor.common.v1.Cell
	28,  // 93: rimgovernor.operations.v1.CancelAcquisition.source:type_name -> rimgovernor.operations.v1.EntityPrecondition
	124, // 94: rimgovernor.operations.v1.CancelAcquisition.cell:type_name -> rimgovernor.common.v1.Cell
	28,  // 95: rimgovernor.operations.v1.DesignateThing.target:type_name -> rimgovernor.operations.v1.EntityPrecondition
	0,   // 96: rimgovernor.operations.v1.DesignateThing.designation:type_name -> rimgovernor.operations.v1.ThingDesignation
	28,  // 97: rimgovernor.operations.v1.PatchBuilding.building:type_name -> rimgovernor.operations.v1.EntityPrecondition
	1,   // 98: rimgovernor.operations.v1.PatchBuilding.power:type_name -> rimgovernor.operations.v1.PowerSetting
	...
	44,  // 101: rimgovernor.operations.v1.PatchPawn.work:type_name -> rimgovernor.operations.v1.WorkPriority
	45,  // 102: rimgovernor.operations.v1.PatchPawn.schedule:type_name -> rimgovernor.operations.v1.Schedule
	2,   // 103: rimgovernor.operations.v1.PatchPawn.medical_care:type_name -> rimgovernor.operations.v1.MedicalCare
	3,   // 104: rimgovernor.operations.v1.PatchPawn.hostility_response:type_name -> rimgovernor.operations.v1.HostilityResponse
	...
	46,  // 107: rimgovernor.operations.v1.PatchPawn.training:type_name -> rimgovernor.operations.v1.Training
	61,  // 108: rimgovernor.operations.v1.PatchPawn.food_allow:type_name -> rimgovernor.operations.v1.DefinitionList
	48,  // 109: rimgovernor.operations.v1.SelectorList.selectors:type_name -> rimgovernor.operations.v1.FilterSelector
	49,  // 110: rimgovernor.operations.v1.FilterPatch.replace:type_name -> rimgovernor.operations.v1.SelectorList
	48,  // 111: rimgovernor.operations.v1.FilterPatch.allow:type_name -> rimgovernor.operations.v1.FilterSelector
	48,  // 112: rimgovernor.operations.v1.FilterPatch.disallow:type_name -> rimgovernor.operations.v1.FilterSelector
	5,   // 113: rimgovernor.operations.v1.BillStore.mode:type_name -> rimgovernor.operations.v1.StoreMode
	4,   // 114: rimgovernor.operations.v1.BillSettings.repeat_mode:type_name -> rimgovernor.operations.v1.RepeatMode
	31,  // 115: rimgovernor.operations.v1.BillSettings.worker:type_name -> rimgovernor.operations.v1.Assignment
	51,  // 116: rimgovernor.operations.v1.BillSettings.store:type_name -> rimgovernor.operations.v1.BillStore
	50,  // 117: rimgovernor.operations.v1.BillSettings.ingredients:type_name -> rimgovernor.operations.v1.FilterPatch
	28,  // 118: rimgovernor.operations.v1.AddBill.bench:type_name -> rimgovernor.operations.v1.EntityPrecondition
	52,  // 119: rimgovernor.operations.v1.AddBill.settings:type_name -> rimgovernor.operations.v1.BillSettings
	28,  // 120: rimgovernor.operations.v1.BillPrecondition.bench:type_name -> rimgovernor.operations.v1.EntityPrecondition
	54,  // 121: rimgovernor.operations.v1.PatchBill.bill:type_name -> rimgovernor.operations.v1.BillPrecondition
	52,  // 122: rimgovernor.operations.v1.PatchBill.settings:type_name -> rimgovernor.operations.v1.BillSettings
	54,  // 123: rimgovernor.operations.v1.DeleteBill.bill:type_name -> rimgovernor.operations.v1.BillPrecondition
	54,  // 124: rimgovernor.operations.v1.MoveBill.bill:type_name -> rimgovernor.operations.v1.BillPrecondition
	124, // 125: rimgovernor.operations.v1.DrillPolicy.cell:type_name -> rimgovernor.common.v1.Cell
	32,  // 126: rimgovernor.operations.v1.DefCounts.rows:type_name -> rimgovernor.operations.v1.DefCount
	59,  // 127: rimgovernor.operations.v1.DrillPolicies.rows:type_name -> rimgovernor.operations.v1.DrillPolicy
	60,  // 128: rimgovernor.operations.v1.SetProductionPolicy.floors:type_name -> rimgovernor.operations.v1.DefCounts
	60,  // 129: rimgovernor.operations.v1.SetProductionPolicy.commitments:type_name -> rimgovernor.operations.v1.DefCounts
	61,  // 130: rimgovernor.operations.v1.SetProductionPolicy.stopped_defs:type_name -> rimgovernor.operations.v1.DefinitionList
	62,  // 131: rimgovernor.operations.v1.SetProductionPolicy.drills:type_name -> rimgovernor.operations.v1.DrillPolicies
	7,   // 132: rimgovernor.operations.v1.StockpileSettings.priority:type_name -> rimgovernor.operations.v1.StoragePriority
	8,   // 133: rimgovernor.operations.v1.StockpileSettings.preset:type_name -> rimgovernor.operations.v1.FilterPreset
	50,  // 134: rimgovernor.operations.v1.StockpileSettings.filter:type_name -> rimgovernor.operations.v1.FilterPatch
	6,   // 135: rimgovernor.operations.v1.CreateZone.type:type_name -> rimgovernor.operations.v1.ZoneType
	35,  // 136: rimgovernor.operations.v1.CreateZone.cells:type_name -> rimgovernor.operations.v1.Cells
	64,  // 137: rimgovernor.operations.v1.CreateZone.stockpile:type_name -> rimgovernor.operations.v1.StockpileSettings
	65,  // 138: rimgovernor.operations.v1.CreateZone.growing:type_name -> rimgovernor.operations.v1.GrowingSettings
	66,  // 139: rimgovernor.operations.v1.CreateZone.fishing:type_name -> rimgovernor.operations.v1.FishingSettings
	28,  // 140: rimgovernor.operations.v1.DeleteZone.zone:type_name -> rimgovernor.operations.v1.EntityPrecondition
	28,  // 141: rimgovernor.operations.v1.EditZoneCells.zone:type_name -> rimgovernor.operations.v1.EntityPrecondition
	9,   // 142: rimgovernor.operations.v1.EditZoneCells.edit:type_name -> rimgovernor.operations.v1.CellEdit
	35,  // 143: rimgovernor.operations.v1.EditZoneCells.cells:type_name -> rimgovernor.operations.v1.Cells
	28,  // 144: rimgovernor.operations.v1.RepairZone.zone:type_name -> rimgovernor.operations.v1.EntityPrecondition
	28,  // 145: rimgovernor.operations.v1.PatchStockpile.zone:type_name -> rimgovernor.operations.v1.EntityPrecondition
	64,  // 146: rimgovernor.operations.v1.PatchStockpile.settings:type_name -> rimgovernor.operations.v1.StockpileSettings
	28,  // 147: rimgovernor.operations.v1.PatchGrowing.zone:type_name -> rimgovernor.operations.v1.EntityPrecondition
	65,  // 148: rimgovernor.operations.v1.PatchGrowing.settings:type_name -> rimgovernor.operations.v1.GrowingSettings
	28,  // 149: rimgovernor.operations.v1.ExtendHome.target:type_name -> rimgovernor.operations.v1.EntityPrecondition
	28,  // 150: rimgovernor.operations.v1.AssignBed.pawn:type_name -> rimgovernor.operations.v1.EntityPrecondition
	28,  // 151: rimgovernor.operations.v1.AssignBed.bed:type_name -> rimgovernor.operations.v1.EntityPrecondition
	31,  // 152: rimgovernor.operations.v1.AssignBed.expected_previous_bed:type_name -> rimgovernor.operations.v1.Assignment
	28,  // 153: rimgovernor.operations.v1.Deconstruct.target:type_name -> rimgovernor.operations.v1.EntityPrecondition
	28,  // 154: rimgovernor.operations.v1.RemoveWall.wall:type_name -> rimgovernor.operations.v1.EntityPrecondition
	28,  // 155: rimgovernor.operations.v1.Arrest.pawn:type_name -> rimgovernor.operations.v1.EntityPrecondition
	28,  // 156: rimgovernor.operations.v1.Arrest.target:type_name -> rimgovernor.operations.v1.EntityPrecondition
	28,  // 157: rimgovernor.operations.v1.Arrest.bed:type_name -> rimgovernor.operations.v1.EntityPrecondition
	28,  // 158: rimgovernor.operations.v1.RecoveryArea.pawn:type_name -> rimgovernor.operations.v1.EntityPrecondition
	28,  // 159: rimgovernor.operations.v1.RecoveryArea.area:type_name -> rimgovernor.operations.v1.EntityPrecondition
	28,  // 160: rimgovernor.operations.v1.RecoverService.target:type_name -> rimgovernor.operations.v1.EntityPrecondition
	28,  // 161: rimgovernor.operations.v1.RecoverService.pawn:type_name -> rimgovernor.operations.v1.EntityPrecondition
	10,  // 162: rimgovernor.operations.v1.RecoverService.method:type_name -> rimgovernor.operations.v1.ServiceMethod
	28,  // 163: rimgovernor.operations.v1.ManageWaste.target:type_name -> rimgovernor.operations.v1.EntityPrecondition
	28,  // 164: rimgovernor.operations.v1.ManageWaste.pawn:type_name -> rimgovernor.operations.v1.EntityPrecondition
	30,  // 165: rimgovernor.operations.v1.ExpectedJob.idle:type_name -> rimgovernor.operations.v1.Clear
	28,  // 166: rimgovernor.operations.v1.RelieveNeed.pawn:type_name -> rimgovernor.operations.v1.EntityPrecondition
	11,  // 167: rimgovernor.operations.v1.RelieveNeed.need:type_name -> rimgovernor.operations.v1.Need
	83,  // 168: rimgovernor.operations.v1.RelieveNeed.expected_job:type_name -> rimgovernor.operations.v1.ExpectedJob
	28,  // 169: rimgovernor.operations.v1.ImproveGear.pawn:type_name -> rimgovernor.operations.v1.EntityPrecondition
	28,  // 170: rimgovernor.operations.v1.ImproveGear.target:type_name -> rimgovernor.operations.v1.EntityPrecondition
	28,  // 171: rimgovernor.operations.v1.QueueSurgery.patient:type_name -> rimgovernor.operations.v1.EntityPrecondition
	2,   // 172: rimgovernor.operations.v1.QueueSurgery.expected_care:type_name -> rimgovernor.operations.v1.MedicalCare
	28,  // 173: rimgovernor.operations.v1.SetAnimalTraining.animal:type_name -> rimgovernor.operations.v1.EntityPrecondition
	28,  // 174: rimgovernor.operations.v1.SlaughterAnimal.animal:type_name -> rimgovernor.operations.v1.EntityPrecondition
	28,  // 175: rimgovernor.operations.v1.TameAnimal.animal:type_name -> rimgovernor.operations.v1.EntityPrecondition
	28,  // 176: rimgovernor.operations.v1.ReleaseAnimal.animal:type_name -> rimgovernor.operations.v1.EntityPrecondition
	28,  // 177: rimgovernor.operations.v1.SetAnimalArea.animal:type_name -> rimgovernor.operations.v1.EntityPrecondition
	31,  // 178: rimgovernor.operations.v1.SetAnimalArea.area:type_name -> rimgovernor.operations.v1.Assignment
	28,  // 179: rimgovernor.operations.v1.SetAnimalMaster.animal:type_name -> rimgovernor.operations.v1.EntityPrecondition
	31,  // 180: rimgovernor.operations.v1.SetAnimalMaster.master:type_name -> rimgovernor.operations.v1.Assignment
	28,  // 181: rimgovernor.operations.v1.SetAnimalFollowing.animal:type_name -> rimgovernor.operations.v1.EntityPrecondition
	28,  // 182: rimgovernor.operations.v1.SetPrisonerInteraction.pawn:type_name -> rimgovernor.operations.v1.EntityPrecondition
	12,  // 183: rimgovernor.operations.v1.SetPrisonerInteraction.interaction:type_name -> rimgovernor.operations.v1.PrisonerInteraction
	28,  // 184: rimgovernor.operations.v1.SetDrafted.pawn:type_name -> rimgovernor.operations.v1.EntityPrecondition
	28,  // 185: rimgovernor.operations.v1.MovePawn.pawn:type_name -> rimgovernor.operations.v1.EntityPrecondition
	124, // 186: rimgovernor.operations.v1.MovePawn.destination:type_name -> rimgovernor.common.v1.Cell
	28,  // 187: rimgovernor.operations.v1.AttackTarget.pawn:type_name -> rimgovernor.operations.v1.EntityPrecondition
	28,  // 188: rimgovernor.operations.v1.AttackTarget.target:type_name -> rimgovernor.operations.v1.EntityPrecondition
	13,  // 189: rimgovernor.operations.v1.AttackTarget.mode:type_name -> rimgovernor.operations.v1.AttackMode
	28,  // 190: rimgovernor.operations.v1.PawnTargetOrder.pawn:type_name -> rimgovernor.operations.v1.EntityPrecondition
	28,  // 191: rimgovernor.operations.v1.PawnTargetOrder.target:type_name -> rimgovernor.operations.v1.EntityPrecondition
	14,  // 192: rimgovernor.operations.v1.PawnTargetOrder.kind:type_name -> rimgovernor.operations.v1.PawnOrderKind
	28,  // 193: rimgovernor.operations.v1.OpenTrade.trader:type_name -> rimgovernor.operations.v1.EntityPrecondition
	28,  // 194: rimgovernor.operations.v1.OpenTrade.negotiator:type_name -> rimgovernor.operations.v1.EntityPrecondition
	28,  // 195: rimgovernor.operations.v1.SetTradeLines.session:type_name -> rimgovernor.operations.v1.EntityPrecondition
	100, // 196: rimgovernor.operations.v1.SetTradeLines.lines:type_name -> rimgovernor.operations.v1.TradeLine
	28,  // 197: rimgovernor.operations.v1.AcceptTrade.session:type_name -> rimgovernor.operations.v1.EntityPrecondition
	32,  // 198: rimgovernor.operations.v1.AcceptTrade.economic_floors:type_name -> rimgovernor.operations.v1.DefCount
	28,  // 199: rimgovernor.operations.v1.EndTrade.session:type_name -> rimgovernor.operations.v1.EntityPrecondition
	15,  // 200: rimgovernor.operations.v1.EndTrade.kind:type_name -> rimgovernor.operations.v1.EndTradeKind
	104, // 201: rimgovernor.operations.v1.FormCaravan.cargo:type_name -> rimgovernor.operations.v1.CargoSelection
	28,  // 202: rimgovernor.operations.v1.TravelCaravan.caravan:type_name -> rimgovernor.operations.v1.EntityPrecondition
	16,  // 203: rimgovernor.operations.v1.TravelCaravan.kind:type_name -> rimgovernor.operations.v1.TravelKind
	28,  // 204: rimgovernor.operations.v1.GiftCaravanSilver.caravan:type_name -> rimgovernor.operations.v1.EntityPrecondition
	28,  // 205: rimgovernor.operations.v1.GiftCaravanSilver.faction:type_name -> rimgovernor.operations.v1.EntityPrecondition
	28,  // 206: rimgovernor.operations.v1.AcceptQuest.quest:type_name -> rimgovernor.operations.v1.EntityPrecondition
	28,  // 207: rimgovernor.operations.v1.FulfillQuest.quest:type_name -> rimgovernor.operations.v1.EntityPrecondition
	28,  // 208: rimgovernor.operations.v1.FulfillQuest.caravan:type_name -> rimgovernor.operations.v1.EntityPrecondition
	120, // 209: rimgovernor.operations.v1.ReleaseOwnedDraftRequest.identity:type_name -> rimgovernor.common.v1.Identity
	28,  // 210: rimgovernor.operations.v1.ReleaseOwnedDraftRequest.pawn:type_name -> rimgovernor.operations.v1.EntityPrecondition
	112, // 211: rimgovernor.operations.v1.DraftRelease.request:type_name -> rimgovernor.operations.v1.ReleaseOwnedDraftRequest
	121, // 212: rimgovernor.operations.v1.DraftRelease.context:type_name -> rimgovernor.common.v1.ObservationContext
	127, // 213: rimgovernor.operations.v1.DraftRelease.observed:type_name -> rimgovernor.receipts.v1.JobEffect
	112, // 214: rimgovernor.operations.v1.DraftReleaseUncertain.request:type_name -> rimgovernor.operations.v1.ReleaseOwnedDraftRequest
	121, // 215: rimgovernor.operations.v1.DraftReleaseUncertain.context:type_name -> rimgovernor.common.v1.ObservationContext
	113, // 216: rimgovernor.operations.v1.ReleaseOwnedDraftReply.released:type_name -> rimgovernor.operations.v1.DraftRelease
	113, // 217: rimgovernor.operations.v1.ReleaseOwnedDraftReply.already_released:type_name -> rimgovernor.operations.v1.DraftRelease
	114, // 218: rimgovernor.operations.v1.ReleaseOwnedDraftReply.uncertain:type_name -> rimgovernor.operations.v1.DraftReleaseUncertain
	119, // 219: rimgovernor.operations.v1.ReleaseOwnedDraftReply.failure:type_name -> rimgovernor.common.v1.Failure
	28,  // 220: rimgovernor.operations.v1.SetApparelPolicy.pawn:type_name -> rimgovernor.operations.v1.EntityPrecondition
	19,  // 221: rimgovernor.operations.v1.Operations.Preview:input_type -> rimgovernor.operations.v1.PreviewRequest
	17,  // 222: rimgovernor.operations.v1.Operations.Execute:input_type -> rimgovernor.operations.v1.ExecuteRequest
	112, // 223: rimgovernor.operations.v1.Operations.ReleaseOwnedDraft:input_type -> rimgovernor.operations.v1.ReleaseOwnedDraftRequest
	20,  // 224: rimgovernor.operations.v1.Operations.Preview:output_type -> rimgovernor.operations.v1.PreviewReply
	18,  // 225: rimgovernor.operations.v1.Operations.Execute:output_type -> rimgovernor.operations.v1.ExecuteReply
	115, // 226: rimgovernor.operations.v1.Operations.ReleaseOwnedDraft:output_type -> rimgovernor.operations.v1.ReleaseOwnedDraftReply
	224, // [224:227] is the sub-list for method output_type
	221, // [221:224] is the sub-list for method input_type
