...
internal static class NativeRangedCausalityProgram
{
    ...
    static void Set(object value,string n,object? data)
    {
        ...
        var method=new DynamicMethod("SetFixtureField",typeof(void),new[]{typeof(object),typeof(object)},typeof(NativeRangedCausalityProgram),true);
    ...
    static void Run()
    {
        ...
        sink.Patch(Method("NativeLaunch"),prefix:new HarmonyMethod(typeof(NativeRangedCausalityProgram),nameof(LaunchSink)){priority=Priority.Last});
        sink.Patch(Method("DamageTarget"),prefix:new HarmonyMethod(typeof(NativeRangedCausalityProgram),nameof(DamageSink)){priority=Priority.Last});
        ...
        sink.Patch(MeleeMethod("MeleeTarget"),prefix:new HarmonyMethod(typeof(NativeRangedCausalityProgram),nameof(MeleeSink)){priority=Priority.Last});
...
internal static class NativeRangedCausalityProbe
{
    internal static int Invoke(string[] args)
    {
        try
        {
            ...
            typeof(NativeRangedCausalityProbe).Assembly.GetType("NativeRangedCausalityProgram",true)!.GetMethod("Start",BindingFlags.Static|BindingFlags.NonPublic)!.Invoke(null,new object[]{args[0]});return 0;
        }
