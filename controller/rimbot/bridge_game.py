...
READS = OBSERVATION_TOOLS | frozenset({'home/wall_upgrade_sites', 'home/roof_support', 'home/recovery_state', 'home/husbandry_facts', 'home/waste_state', 'home/population', 'home/resource_sources',
...
WRITES = frozenset({'home/upkeep_home', 'home/upkeep_wall', 'home/upkeep_bed', 'home/recovery_area', 'home/recover_service', 'home/husbandry_config', 'home/relieve_need', 'home/medical_operations', 'home/caravan_gift', 'home/fulfill_quest', 'home/caravan', 'home/accept_quest', 'home/manage_waste', 'home/gear_upkeep', 'home/population', 'home/acquire_resource', 'home/production_policy', 'home/cancel_construction', 'home/confirm_colony_names', 'home/zone_cells', 'home/place_building', 'home/pawn_config',
...
class BridgeGame(ObservationGateway):
    ...
    async def invoke(self, tool, arguments, *, allow_write=False):
        ...
        if tool in ('home/caravan_gift', 'home/fulfill_quest', 'home/accept_quest', 'home/caravan') and payload.get('accepted') is not True:
