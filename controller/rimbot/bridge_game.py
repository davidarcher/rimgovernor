...
READS = OBSERVATION_TOOLS | frozenset({'home/waste_state', 'home/population', 'home/resource_sources',
...
WRITES = frozenset({'home/relieve_need', 'home/manage_waste', 'home/gear_upkeep', 'home/population', 'home/acquire_resource', 'home/production_policy', 'home/cancel_construction', 'home/confirm_colony_names', 'home/zone_cells', 'home/place_building', 'home/pawn_config',
...
class BridgeGame(ObservationGateway):
    ...
    async def invoke(self, tool, arguments, *, allow_write=False):
        ...
        if (tool == 'home/install' or (tool == 'home/manage_waste' and arguments.get('dryRun') is False)) and payload.get('accepted') is not True:
