...
def project_context(context):
    ...
    def project(p):
        ...
        out={k:v for k,v in p.items() if k in (*keep,'admin_hold','after_projects','deadline_tick','deadline_overdue','dependency_blockers','dependency_checks','work_policy','work_allocation')}
