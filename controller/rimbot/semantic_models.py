...
class ObjectiveDecision(Decision):
    escalation_reason: str = Field(default="",max_length=2000,description="If uncertainty or conflicting objectives are too complex to resolve reliably, explain the specific unresolved question here and leave ALL decision fields empty. This requests one review by the larger model; it authorizes no changes.")
