...
export function readNotifications(value: unknown): Notifications {
 ...
 const section = (value: unknown, kind: 'letters' | 'messages' | 'alerts', limit: number): NoticeSection => {
  ...
  optional(o.snapshotFingerprint, id);
